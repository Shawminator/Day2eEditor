...
namespace ExpansionPlugin
{
    ...
    /// </summary>
    public partial class ExpansionRaidSettingsBarbedWireControl : UserControl, IUIHandler
    {
        ...
        public ExpansionRaidSettingsBarbedWireControl()
        {
            InitializeComponent();
        }
        ...
        public void LoadFromData(Type parentType, object data, List<TreeNode> selectedNodes)
        {
            ...
            BarbedWireRaidToolTimeSecondsNUD.Value = (decimal)_data.BarbedWireRaidToolTimeSeconds;
            BarbedWireRaidToolCyclesNUD.Value = (decimal)_data.BarbedWireRaidToolCycles;
            BarbedWireRaidToolDamagePercentNUD.Value = (decimal)_data.BarbedWireRaidToolDamagePercent;
        ...
        private void CanRaidBarbedWireCB_CheckedChanged(object sender, EventArgs e)
        {
