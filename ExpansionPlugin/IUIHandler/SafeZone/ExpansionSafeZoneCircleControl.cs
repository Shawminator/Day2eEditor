...
namespace ExpansionPlugin
{
    ...
    /// </summary>
    public partial class ExpansionSafeZoneCircleControl : UserControl, IUIHandler
    {
        private Type _parentType;
        public event Action<Vec3> PositionChanged;
        public event Action<decimal> RadiusChanged;
        private ExpansionSafeZoneCircle _data;
        private List<TreeNode> _nodes;
        private bool _suppressEvents;

        public ExpansionSafeZoneCircleControl()
        {
            InitializeComponent();
        }
        ...
        public void LoadFromData(Type parentType, object data, List<TreeNode> selectedNodes)
        {
            ...
            _data = data as ExpansionSafeZoneCircle ?? throw new InvalidCastException();
