...
namespace ExpansionPlugin
{
    ...
    /// </summary>
    public partial class ExpansionMissionEventContaminatedAreaPlayerDataControl : UserControl, IUIHandler
    {
        ...
        public ExpansionMissionEventContaminatedAreaPlayerDataControl()
        {
            InitializeComponent();
        }
        ...
        private PlayerData CloneData(PlayerData data)
        {
            ...
            {
                AroundPartName = data.AroundPartName,
                TinyPartName = data.TinyPartName,
                PPERequesterType = data.PPERequesterType
            };
        }
