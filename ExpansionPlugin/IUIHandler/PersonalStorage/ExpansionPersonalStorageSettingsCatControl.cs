...
namespace ExpansionPlugin
{
    ...
    /// </summary>
    public partial class ExpansionPersonalStorageSettingsCatControl : UserControl, IUIHandler
    {
        private Type _parentType;
        private ExpansionPersonalStorageMenuCategoryBase _data;
        private List<TreeNode> _nodes;
        private bool _suppressEvents;

        public ExpansionPersonalStorageSettingsCatControl()
        {
            InitializeComponent();
        }
        ...
        public void LoadFromData(Type parentType, object data, List<TreeNode> selectedNodes)
        {
            ...
            _data = data as ExpansionPersonalStorageMenuCategoryBase ?? throw new InvalidCastException();
