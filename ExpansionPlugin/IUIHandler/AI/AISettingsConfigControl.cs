...
namespace ExpansionPlugin
{
    ...
    public partial class AISettingsConfigControl : UserControl, IUIHandler
    {
        ...
        public void LoadFromData(Type parentType, object data, List<TreeNode> selectedNodes)
        {
            ...
            ShoryukenChanceNUD.Value = (decimal)_data.ShoryukenChance;
            ShoryukenDamageMultiplierNUD.Value = (decimal)_data.ShoryukenDamageMultiplier;
        ...
        private void ShoryukenChanceNUD_ValueChanged(object sender, EventArgs e)
        {
            if (_suppressEvents) return;
            _data.ShoryukenChance = ShoryukenChanceNUD.Value;
        }

        private void ShoryukenDamageMultiplierNUD_ValueChanged(object sender, EventArgs e)
        {
            if (_suppressEvents) return;
            _data.ShoryukenDamageMultiplier = ShoryukenDamageMultiplierNUD.Value;
        }
